<template>
  <q-page class="row no-wrap" padding style="padding-top: 46px">
    <div class="col q-ma-md">
      <div class="full-height">
        <q-card padding>
          <q-img src="teachers5.jpg" style="max-height: 400px">
            <div class="absolute-bottom text-white text-h5 text-weight-light text-h4 text-left bg-deep-orange">
              <q-item-label>
                Sobre a necessidade de promoção e formação de competências digitais nos Educadores
              </q-item-label>
            </div>
          </q-img>
