<template>
  <q-layout view="hHh Lpr lff" class="shadow-2 rounded-borders">
    ...
    <q-drawer v-model="leftDrawerOpen" show-if-above bordered elevated class="bg-primary text-black">
      ...
      <q-list>
        ...
        <EssentialLink v-for="link in essentialLinks" :key="link.title" v-bind="link" class="text-white" />
      </q-list>
    </q-drawer>
