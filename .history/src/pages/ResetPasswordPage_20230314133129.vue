<template>
  <q-page class="bg-green-1 row justify-center items-center">
    <q-form class="square-card row justify-center" @submit.prevent="handlerPasswordReset">
      <q-card square bordered class="q-pa-sm shadow-1">
        ...
        <q-card-section>
          <div class="col-md-4 col-sm-6 col-xs-10 q-gutter-y-md">
            <q-input outlined bottom-slots v-model="password" label="Nova senha" :type="visibility" lazy-rules :rules="[
