      ...
      <q-card square bordered class="q-pa-sm shadow-1">
        ...
        <q-card-section>
          <div class="col-md-4 col-sm-6 col-xs-10 q-gutter-y-md">
            ...
            <q-input bottom-slots v-model="form.password" label="Nova senha" counter :type="visibility" lazy-rules :rules="[
            ...
            <q-btn label="Esqueci minha senha!" color="primary" class="full-width" flat
