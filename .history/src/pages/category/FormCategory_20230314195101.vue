<template>
  <q-page padding>
    <q-form class="row text-align-left" @submit.prevent="handleSubmit">
      <q-card
        class="bordered q-table__container q-table--horizontal-separator column no-wrap q-table__card q-table--no-wrap col-12">
        <q-card-section>
