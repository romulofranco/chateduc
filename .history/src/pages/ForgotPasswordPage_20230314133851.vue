<template>
  <q-page class="bg-green-1 row justify-center items-center">
    <q-form class="square-card row justify-center" @submit.prevent="handlerForgotReset">
      <q-card square class="q-pa-sm shadow-1">
        ...
        <q-card-section>
          <div class="col-md-2 col-sm-6 col-xs-10 q-gutter-y-md">
            <q-input bottom-slots v-model="email" label="Email" type="email" lazy-rules :rules="[
            ...
            <q-btn label="Voltar para login" color="primary" class="full-width" flat :to="{ name: 'login' }"></q-btn>
          </div>
        </q-card-section>
      </q-card>
    </q-form>
